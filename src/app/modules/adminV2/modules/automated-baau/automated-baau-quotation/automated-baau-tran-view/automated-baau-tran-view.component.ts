...
@Component({
  selector: 'app-automated-baau-tran-view',
  templateUrl: './automated-baau-tran-view.component.html',
  styleUrls: ['./automated-baau-tran-view.component.scss']
})
export class AutomatedBaauTranViewComponent implements OnInit {
