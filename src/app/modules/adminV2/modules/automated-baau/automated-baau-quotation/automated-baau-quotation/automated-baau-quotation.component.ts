...
@Component({
  selector: 'app-automated-baau-quotation',
  templateUrl: './automated-baau-quotation.component.html',
  styleUrls: ['./automated-baau-quotation.component.scss']
})
export class AutomatedBaauQuotationComponent implements OnInit{
